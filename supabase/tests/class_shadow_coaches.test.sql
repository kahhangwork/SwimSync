...
SELECT 'a3000000-0000-0000-0000-000000000001', c.id, 'Shadow Lane', 'saturday','09:00','10:00',(SELECT l.id FROM locations l WHERE l.tenant_id = c.tenant_id AND lower(trim(l.name)) = 'default location'), 40,
...
INSERT INTO classes (id, coach_id, title, day_of_week, start_time, end_time, location_id, price_per_lesson, category_id)
SELECT 'a3000000-0000-0000-0000-000000000002', c.id, 'Quiet Lane', 'saturday','11:00','12:00',(SELECT l.id FROM locations l WHERE l.tenant_id = c.tenant_id AND lower(trim(l.name)) = 'default location'), 40,
       (SELECT cc.id FROM class_categories cc
         WHERE cc.tenant_id = c.tenant_id AND lower(trim(cc.name)) = 'default group')
  FROM coaches c WHERE c.profile_id = 'a2000000-0000-0000-0000-000000000002';

...
SELECT 'cf000000-0000-0000-0000-0000000000a1', co.id, 'C', 'monday',
       '10:00','11:00',(SELECT l.id FROM locations l WHERE l.tenant_id = co.tenant_id AND lower(trim(l.name)) = 'default location'), 50.00, 'ce000000-0000-0000-0000-0000000000a1'

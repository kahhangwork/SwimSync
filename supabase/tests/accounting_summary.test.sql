...
SELECT v.id, '85000000-0000-0000-0000-0000000000a0',
       ...
       v.title,'monday','10:00','11:00',(SELECT l.id FROM locations l WHERE l.tenant_id = '85000000-0000-0000-0000-0000000000a0' AND lower(trim(l.name)) = 'default location'),30,

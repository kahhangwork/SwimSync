...
SELECT '6a000000-0000-0000-0000-000000000001', c.id, 'Act Class', 'saturday','09:00','10:00',(SELECT l.id FROM locations l WHERE l.tenant_id = c.tenant_id AND lower(trim(l.name)) = 'default location'), 30,

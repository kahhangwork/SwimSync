...
SELECT 'bf000000-0000-0000-0000-000000000001', co.id, 'PP Class', 'saturday', '10:00','11:00',(SELECT l.id FROM locations l WHERE l.tenant_id = co.tenant_id AND lower(trim(l.name)) = 'default location'), 30.00,

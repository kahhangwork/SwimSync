...
SELECT '66000000-0000-0000-0000-000000000001', c.id, 'Long Lane', 'saturday','10:00','11:30',(SELECT l.id FROM locations l WHERE l.tenant_id = c.tenant_id AND lower(trim(l.name)) = 'default location'), 40,
...
RESET ROLE;
INSERT INTO classes (id, coach_id, title, day_of_week, start_time, end_time, location_id, price_per_lesson, tenant_id, category_id)
SELECT '66000000-0000-0000-0000-000000000009', c.id, 'Rateless', 'sunday','10:00','11:00',(SELECT l.id FROM locations l WHERE l.tenant_id = c.tenant_id AND lower(trim(l.name)) = 'default location'), 40,

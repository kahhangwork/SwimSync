...
INSERT INTO classes (id,coach_id,title,day_of_week,start_time,end_time,location_name,price_per_lesson,category_id)
  SELECT 'df000000-0000-0000-0000-0000000000c1',co.id,'Mon','monday','10:00','11:00','Pool',50,'de000000-0000-0000-0000-0000000000c1' FROM coaches co JOIN profiles pr ON pr.id=co.profile_id WHERE pr.email='lb-admin@test.local';

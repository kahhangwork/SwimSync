...
exec deno test --allow-net --allow-env core.test.ts orderingGuard.test.ts email.test.ts dates.test.ts packages.test.ts unclaimed.test.ts trials.test.ts makeups.test.ts enrolmentSpans.test.ts classDeactivation.test.ts guestOnlyClass.test.ts cancelledLessons.test.ts runLog.test.ts ../package-emails/email.test.ts ../credit-note-emails/email.test.ts ../credit-note-emails/core.test.ts ../public-invoice/core.test.ts ../public-package/core.test.ts

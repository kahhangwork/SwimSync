...
exec deno test --allow-net --allow-env core.test.ts email.test.ts dates.test.ts packages.test.ts unclaimed.test.ts trials.test.ts makeups.test.ts enrolmentSpans.test.ts ../package-emails/email.test.ts ../public-invoice/core.test.ts

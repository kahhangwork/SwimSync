...
(a separate path — see §7.8). **Activation:** the Edge Function must be deployed and a
`RESEND_API_KEY` secret set; until then generation runs unchanged and sends nothing.

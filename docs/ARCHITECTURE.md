...
| `SwimSyncAdmin/lib/lessonMarking.ts` | Which statuses a roster row may take (trial statuses for trial guests only), the client markability affordance, the holiday-confirm count |
